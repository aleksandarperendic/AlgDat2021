...
public class HashMap {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < strings.length; i++) {
            ...
            int hashmap_index = compute_hashmapindex(hash, hashmap_size);
        ...
        int hash = hash("Test2");
        int hashmap_index = compute_hashmapindex(hash, hashmap_size);
        System.out.println(hash_map.get(hashmap_index));
    }

    static int compute_hashmapindex(int hash, int hashmap_size) {
